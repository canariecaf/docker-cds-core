...
ENV CDS_DEVELOPMENTMODE=$CDS_DEVELOPMENTMODE
...
ENV CDS_COMMONDOMAIN=$CDS_COMMONDOMAIN
...
RUN echo "CDS_COMMONDOMAIN=${CDS_COMMONDOMAIN}" >> ${CDS_BUILD_ENV}
RUN echo "CDS_DEVELOPMENTMODE=${CDS_DEVELOPMENTMODE}" >> ${CDS_BUILD_ENV}
